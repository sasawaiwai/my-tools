...
const gods = [
  ...
  { name: "シュブ＝ニグラス", typeName: "生命と群れの祝祭信者", catch: "生きること、増えること、満ちること。それが信仰の形。", tendency: "生命力への崇敬と祝祭の歓喜に強く惹かれる。群れの中にいるとき、自分が最もよく生きていると感じる。", role: "生命の礼賛者。森の祭りで叫び、踊り、増えゆくものを心から祝福する者。", doom: "自分が群れの一部になりすぎて、個としての自分が静かに消えていく。", good: "ダゴン／ヒュドラ", bad: "ツァトゥグァ", skills: "〈博物学〉〈医学〉〈説得〉", ritual: "深夜の森で、仲間たちと焚き火を囲んで夜明けまで歌う。声が嗄れるまで。", sns: "クトゥルフ神話TRPG狂信者診断、やってみた\n\n結果：「生命と群れの祝祭信者」\n生命と祝祭と繁栄を心から愛します。\n\n#狂信者適性診断 #クトゥルフ神話TRPG" },
  ...
  { name: "アイホート", typeName: "契約と巣に取り込まれる宿主型信者", catch: "契約は対等ではない。でも、あなたはサインした。", tendency: "契約と選択の重さを深く知っており、逃げ道のない取引の中にある種の誠実さを感じる。約束は守られなければならないと、心の底から思っている。", role: "契約の仲介者。取引を成立させ、条件を記憶し、その履行を静かに見届ける者。", doom: "契約に縛られすぎて、自分がいつから何を望んでいたのかを忘れる。", good: "ヨグ＝ソトース", bad: "ノーデンス", skills: "〈法律〉〈言いくるめ〉〈心理学〉", ritual: "深夜に、誰かと約束を交わす。その約束は必ず守られなければならない。", sns: "クトゥルフ神話TRPG狂信者診断、やってみた\n\n結果：「契約と巣に取り込まれる宿主型信者」\n契約を結び、全てを抱えて生きます。\n\n#狂信者適性診断 #クトゥルフ神話TRPG" },
  ...
  { name: "イタクァ", typeName: "極寒と孤独に呼ばれる放浪信者", catch: "孤独は罰ではない。選ばれた者の証だ。", tendency: "孤独と寒さの中にある自由に惹かれる。追放された者への共感と、誰もいない場所への純粋な憧れがある。", role: "放浪の伝令。どこにも属さず、どこへでも行けることを誇りとする者。", doom: "孤独に慣れすぎて、人の温かさに二度と戻れなくなる。", good: "イグ", bad: "シュブ＝ニグラス", skills: "〈ナビゲート〉〈博物学〉〈追跡〉", ritual: "誰もいない場所で、風の音だけを聞きながら夜明けまで立ちつくす。", sns: "クトゥルフ神話TRPG狂信者診断、やってみた\n\n結果：「極寒と孤独に呼ばれる放浪信者」\n孤独と寒さの中にのみ、自由を見ます。\n\n#狂信者適性診断 #クトゥルフ神話TRPG" },
